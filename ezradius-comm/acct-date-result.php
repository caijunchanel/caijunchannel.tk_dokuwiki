...
<div id="container">
  ...
  <div id="mainContent">
	...
	<p><a href="acct-date-input.php">Date input</a> | <a href="acct-date-result-print.php?startDate=<?php echo $_REQUEST['startDate']; ?>&amp;endDate=<?php echo $_REQUEST['endDate']; ?>">Print this page</a> </p>
	<?php
...
<thead class="mythead">
  ...
  <?php do { ?>
    <tr>
	  ...
	  <td><a href="user-detail.php?username=<?php echo $row_rsAcctUser['UserName']; ?>"><?php echo $row_rsAcctUser['UserName']; ?></a></td>
