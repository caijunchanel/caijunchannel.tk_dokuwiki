...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE radgroupreply SET GroupName=%s, Attribute=%s, op=%s, `Value`=%s WHERE id=%s",
...
$colname_rsRadgroupreply = "-1";
if (isset($_GET['id'])) {
  $colname_rsRadgroupreply = $_GET['id'];
}
mysql_select_db($database_cnRadius, $cnRadius);
$query_rsRadgroupreply = sprintf("SELECT * FROM radgroupreply WHERE id = %s", GetSQLValueString($colname_rsRadgroupreply, "int"));
$rsRadgroupreply = mysql_query($query_rsRadgroupreply, $cnRadius) or die(mysql_error());
$row_rsRadgroupreply = mysql_fetch_assoc($rsRadgroupreply);
$totalRows_rsRadgroupreply = mysql_num_rows($rsRadgroupreply);
...
<title>Edit radgroupreply</title>
<!-- InstanceEndEditable -->
...
<fieldset>
<legend>Edit radgroupreply</legend>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">PackageName:</td>
      <td><?php echo $row_rsRadgroupreply['GroupName']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Attribute:</td>
      <td><?php echo $row_rsRadgroupreply['Attribute']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Op:</td>
      <td><input type="text" name="op" value="<?php echo htmlentities($row_rsRadgroupreply['op'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Value:</td>
      <td><input type="text" name="Value" value="<?php echo htmlentities($row_rsRadgroupreply['Value'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="GroupName" value="<?php echo htmlentities($row_rsRadgroupreply['GroupName'], ENT_COMPAT, 'utf-8'); ?>" />
  <input type="hidden" name="Attribute" value="<?php echo htmlentities($row_rsRadgroupreply['Attribute'], ENT_COMPAT, 'utf-8'); ?>" />
  <input type="hidden" name="MM_update" value="form1" />
  <input type="hidden" name="id" value="<?php echo $row_rsRadgroupreply['id']; ?>" />
</form>
</fieldset>
<!-- InstanceEndEditable -->
    <!-- end #mainContent -->
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsRadgroupreply);
?>
