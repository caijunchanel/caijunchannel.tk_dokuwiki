...
isset($_REQUEST['theUser']) ? $theUser = $_REQUEST['theUser'] : $theUser = "";
...
if (isset($_POST['submit'])) {
		...
		$updateSQL = sprintf("UPDATE radacct SET AcctTerminateCause='%s', AcctStopTime=NOW() WHERE UserName='%s' and AcctStopTime IS NULL","Admin-Reset", $theUser);
...
<div id="container">
  ...
  <!-- end #header --></div>
  <div id="mainContent">
    <!-- InstanceBeginEditable name="Main" --><fieldset><legend>Diconnect User</legend>
    <?php
  ...
  <table width="400" border="1">
    <tr>
      ...
      <td><span id="sprytextfield1">
        <label>
        <input name="theUser" type="text" id="theUser" value="<? echo $theUser; ?>" />
        </label>
    ...
    <tr>
      ...
      <label>
      <input name="nasaddr" type="text" id="nasaddr" value="<? echo $nasaddr; ?>" />
      </label>
      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
    </tr>
    <tr>
      <td><strong>NAS Shared Secret </strong></td>
      <td>:</td>
      <td><span id="sprytextfield3">
        <label>
        <input name="nassecret" type="text" id="nassecret" value="<? echo $nassecret; ?>" />
        </label>
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr>
      <td><strong>CoA Port </strong></td>
      <td>:</td>
      <td><span id="sprytextfield4">
      <label>
      <input name="coaport" type="text" id="coaport" value="<? echo $coaport; ?>" />
      </label>
      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><label>
        <input name="submit" type="submit" id="submit" value="Kick user" />
      </label></td>
    </tr>
  </table>
</form>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "ip", {useCharacterMasking:true});
