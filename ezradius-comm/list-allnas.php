...
$query_rsNAS = "SELECT id, nasname, shortname, type, ports, secret, community, `description` FROM nas ORDER BY id DESC";
$rsNAS = mysql_query($query_rsNAS, $cnRadius) or die(mysql_error());
...
<div id="container">
  ...
  <div id="mainContent">
	...
	<p><strong>NAS Lists</strong> | <a href="add-newnas.php">Add new NAS</a> </p>
	...
	<thead class="mythead">
      ...
      <?php do { ?>
        <tr>
          <th><?php echo $row_rsNAS['id']; ?></th>
          <th><?php echo $row_rsNAS['nasname']; ?></th>
          <td><?php echo $row_rsNAS['shortname']; ?></td>
          <td><?php echo $row_rsNAS['type']; ?></td>
          <td><?php echo $row_rsNAS['ports']; ?></td>
          <td><?php echo $row_rsNAS['secret']; ?></td>
          <td><?php echo $row_rsNAS['community']; ?></td>
          <td><?php echo $row_rsNAS['description']; ?></td>
          <td><a href="edit-nas.php?id=<?php echo $row_rsNAS['id']; ?>">Edit</a> <a href="del-nas.php?id=<?php echo $row_rsNAS['id']; ?>">Delete</a> </td>
        </tr>
        <?php } while ($row_rsNAS = mysql_fetch_assoc($rsNAS)); ?>
	  </tbody>
    </table>
	<p>&nbsp;</p>
    <!-- InstanceEndEditable -->
