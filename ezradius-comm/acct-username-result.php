...
<p><a href="acct-username-input.php">Username input</a> | <a href="acct-username-result-print.php?username=<?php echo $_REQUEST['username']; ?>&amp;startDate=<?php echo $_REQUEST['startDate']; ?>&amp;endDate=<?php echo $_REQUEST['endDate']; ?>">Print this page</a> </p>
