...
<fieldset>
<legend>Accounting by UserName and Date</legend>
<form id="form1" name="form1" method="post" action="acct-username-result.php">
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "date", {format:"yyyy-mm-dd", validateOn:["blur", "change"], hint:"yyyy-mm-dd", useCharacterMasking:true, isRequired:false});
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "date", {format:"yyyy-mm-dd", hint:"yyyy-mm-dd", validateOn:["blur", "change"], useCharacterMasking:true, isRequired:false});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "none", {validateOn:["blur"], isRequired:true});
//-->
</script>
<!-- InstanceEndEditable -->
    <!-- end #mainContent -->
