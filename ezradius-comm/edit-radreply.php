...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE radreply SET UserName=%s, Attribute=%s, op=%s, `Value`=%s WHERE id=%s",
  ...
  $updateGoTo = "user-detail.php?username=" . $row_rsRadreply['UserName'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsRadreply = "-1";
if (isset($_GET['id'])) {
  $colname_rsRadreply = $_GET['id'];
}
mysql_select_db($database_cnRadius, $cnRadius);
$query_rsRadreply = sprintf("SELECT * FROM radreply WHERE id = %s", GetSQLValueString($colname_rsRadreply, "int"));
$rsRadreply = mysql_query($query_rsRadreply, $cnRadius) or die(mysql_error());
$row_rsRadreply = mysql_fetch_assoc($rsRadreply);
...
<fieldset>
<legend>Edit radreply</legend>

<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Username:</td>
      <td><?php echo $row_rsRadreply['UserName']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Attribute:</td>
      <td><?php echo $row_rsRadreply['Attribute']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Op:</td>
      <td><input type="text" name="op" value="<?php echo htmlentities($row_rsRadreply['op'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Value:</td>
      <td><input type="text" name="Value" value="<?php echo htmlentities($row_rsRadreply['Value'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="id" value="<?php echo $row_rsRadreply['id']; ?>" />
  <input type="hidden" name="UserName" value="<?php echo htmlentities($row_rsRadreply['UserName'], ENT_COMPAT, 'utf-8'); ?>" />
  <input type="hidden" name="Attribute" value="<?php echo htmlentities($row_rsRadreply['Attribute'], ENT_COMPAT, 'utf-8'); ?>" />
