...
if (isset($_POST['submit'])) {
		require_once('library/libTestNDisconnect.php');
		
		$username = $_POST['username'];
		$password = $_POST['password'];
		$radiusserver = $_POST['radiusserver'];
		$radiusport = $_POST['radiusport'];
		$nasportnumber = $_POST['nasportnumber'];
		$nassecret = $_POST['nassecret'];

		$result=test_user_connectivity($username, $password, $radiusserver, $radiusport, $nasportnumber, $nassecret);
}
?>
...
<title>Test user connectivity</title>
<!-- InstanceEndEditable -->
...
<fieldset>
<legend>Test User Connectivity</legend>
<?php
if (isset($_POST['submit'])) {
...
?>
<form id="form1" name="form1" method="post" action="test-user-connectivity.php">
  <table width="401" border="1">
    ...
    <tr>
      ...
      <label>
      <input name="radiusserver" type="text" id="radiusserver" value="127.0.0.1" />
      </label>
    ...
    <tr>
      ...
      <label>
      <input name="radiusport" type="text" id="radiusport" value="1812" />
      </label>
      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
    </tr>
    <tr>
      ...
      <label>
      <input name="nasportnumber" type="text" id="nasportnumber" value="0" />
      </label>
      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
    </tr>
    <tr>
	  ...
	  <label>
        <input name="nassecret" type="text" id="nassecret" value="<?php echo $configVars['others']['defnassecret']; ?>" />
      </label>
    ...
    <tr>
      <td colspan="3"><label>
        <div align="center">
          <input type="submit" name="submit" id="submit" value="Perform Test" />
        </div>
      </label></td>
    </tr>
  </table>
...
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "ip", {useCharacterMasking:true});
