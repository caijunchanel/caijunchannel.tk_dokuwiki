...
if (isset($_POST['Submit'])) {
	...
	if ($valid) {
		$db = new FFDB();
		$db->open('attribute');
		if (!$rec=$db->getbyfield("value","/".$_POST['value']."/i")) { //add only if the radius attribute doesnt exist
...
<div id="container">
  ...
  <div id="mainContent">
	...
	<fieldset><legend>Add freeRADIUS attribute</legend>
	<?php
	if (!$valid) {
	?>
	...
	<form id="form1" name="form1" method="post" action="<?php echo $PHP_SELF; ?>">
	  <table width="100%" border="0">
        ...
        <tr>
          ...
          <td><p>
            <select name="version">
              <option value="1.1.3">1.1.3 and below</option>
              <option value="1.1.4">1.1.4 and above</option>
              <option value="both">All version</option>
            </select>
          </p>
        ...
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><input type="submit" name="Submit" value="Add attribute" /></td>
        </tr>
      </table>
    </form>
