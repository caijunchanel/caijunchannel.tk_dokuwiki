...
<title>All accountings by Date</title>
<!-- InstanceEndEditable -->
...
<div id="container">
  ...
  <!-- end #header --></div>
  <div id="mainContent">
    <!-- InstanceBeginEditable name="Main" --><fieldset><legend>Accounting by Date</legend>
	<form id="form1" name="form1" method="post" action="acct-date-result.php">
	  <table width="100%" border="0">
        <tr>
	...
	<!--
	var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "date", {format:"yyyy-mm-dd", validateOn:["blur", "change"], hint:"yyyy-mm-dd", useCharacterMasking:true, isRequired:true});
	var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "date", {format:"yyyy-mm-dd", hint:"yyyy-mm-dd", validateOn:["blur", "change"], useCharacterMasking:true, isRequired:true});
	//-->
	</script>
	<!-- InstanceEndEditable -->
    <!-- end #mainContent -->
