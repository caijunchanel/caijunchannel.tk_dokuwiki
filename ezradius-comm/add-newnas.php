...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	if (($_POST["nasname"]=='')||($_POST["shortname"]=='')||($_POST["type"]=='')||($_POST["ports"]=='')||($_POST["secret"]=='')||($_POST["community"]=='')||($_POST["description"]=='')) {
		$valid=false;
	} else {
		$valid=true;
	}
	...
	if ($valid) {
  $insertSQL = sprintf("INSERT INTO nas (nasname, shortname, type, ports, secret, community, `description`) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<div id="container">
  ...
  <div id="mainContent">
	...
	<fieldset><label>Add new NAS</label>
	<?php
	if (!$valid) {
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="nasname" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="type" value="other" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Ports:</td>
          <td><input type="text" name="ports" value="3779" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Secret:</td>
          <td><input type="text" name="secret" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Community:</td>
          <td><input type="text" name="community" value="read" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Description:</td>
          <td><input type="text" name="description" value="RADIUS Client" size="32"></td>
        </tr>
        <tr valign="baseline">
