...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "user-detail.php?username=" . $row_rsRadcheck['UserName'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsRadcheck = "-1";
if (isset($_GET['id'])) {
  $colname_rsRadcheck = $_GET['id'];
}
mysql_select_db($database_cnRadius, $cnRadius);
$query_rsRadcheck = sprintf("SELECT * FROM radcheck WHERE id = %s", GetSQLValueString($colname_rsRadcheck, "int"));
$rsRadcheck = mysql_query($query_rsRadcheck, $cnRadius) or die(mysql_error());
$row_rsRadcheck = mysql_fetch_assoc($rsRadcheck);
$totalRows_rsRadcheck = mysql_num_rows($rsRadcheck);
?>
...
<fieldset>
<legend>Edit radcheck</legend>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Username:</td>
      <td><?php echo $row_rsRadcheck['UserName']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Attribute:</td>
      <td><?php echo $row_rsRadcheck['Attribute']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Op:</td>
      <td><input type="text" name="op" value="<?php echo htmlentities($row_rsRadcheck['op'], ENT_COMPAT, 'utf-8'); ?>" size="32" />      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Value:</td>
      <td><input type="text" name="Value" value="<?php echo htmlentities($row_rsRadcheck['Value'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="id" value="<?php echo $row_rsRadcheck['id']; ?>" />
  <input type="hidden" name="UserName" value="<?php echo htmlentities($row_rsRadcheck['UserName'], ENT_COMPAT, 'utf-8'); ?>" />
  <input type="hidden" name="Attribute" value="<?php echo htmlentities($row_rsRadcheck['Attribute'], ENT_COMPAT, 'utf-8'); ?>" />
