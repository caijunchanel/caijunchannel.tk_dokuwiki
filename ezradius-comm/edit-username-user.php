...
<?php
//update radcheck set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'
//update radreply set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'
//update usergroup set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'
//update radacct set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'
if ((isset($_POST['btnUbah'])) && (isset($_POST['newusername'])) && ($_POST['newusername']<>'')) {
	//update radcheck first
	$updateSQL="update radcheck set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'";
	
	mysql_select_db($database_cnRadius, $cnRadius);
  	$Result1 = mysql_query($updateSQL, $cnRadius) or die(mysql_error());
	
	//update radreply
	$updateSQL="update radreply set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'";
	$Result1 = mysql_query($updateSQL, $cnRadius) or die(mysql_error());

	//update usergroup
	$updateSQL="update usergroup set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'";
	$Result1 = mysql_query($updateSQL, $cnRadius) or die(mysql_error());
	
	//update radacct
	$updateSQL="update radacct set username='".$_POST['newusername']."' where username='".$_POST['oldusername']."'";
	$Result1 = mysql_query($updateSQL, $cnRadius) or die(mysql_error());

  	$updateGoTo = "user-detail.php?username=" . $_POST['newusername'] . "";
...
<form id="form1" name="form1" method="post" action="edit-username-user.php">
  <table width="100%" border="0">
    <tr>
      <td width="12%">Username</td>
      <td width="2%">:</td>
      <td width="86%"><input name="newusername" type="text" id="newusername" value="<?php echo $_GET['username']; ?>" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="submit" name="btnUbah" id="btnUbah" value="Update" />
      <input name="oldusername" type="hidden" id="oldusername" value="<?php echo $_GET['username']; ?>" /></td>
    </tr>
  </table>
</form>
</fieldset>
