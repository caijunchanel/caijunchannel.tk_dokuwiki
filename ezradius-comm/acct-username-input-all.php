...
<div id="container">
  ...
  <div id="mainContent">
	...
	<fieldset><legend>Accounting by Username</legend>
	<form action="acct-username-result-all.php" method="post">
	  <table width="100%" border="0">
        <tr>
          <td width="13%">Username</td>
          <td width="2%">:</td>
          <td width="85%"><span id="sprytextfield1">
	...
	<!--
	var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {validateOn:["blur"], isRequired:true});
	//-->
	</script>
	<!-- InstanceEndEditable -->
    <!-- end #mainContent -->
