...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$query_rsRadCheck= sprintf("SELECT * FROM radcheck WHERE UserName = %s AND Attribute=%s", GetSQLValueString($_POST['UserName'], "text"), GetSQLValueString($_POST['Attribute'], "text"));
	$rsRadCheck = mysql_query($query_rsRadCheck, $cnRadius) or die(mysql_error());
	$totalRows_rsRadCheck = mysql_num_rows($rsRadCheck);
	if ($totalRows_rsRadCheck<=0) { 
...
<fieldset>
<legend>
Add new radcheck attribute</legend>
<?php
