<?php
//check if user is accessing this apps for the first time
if (file_exists('firsttime.txt')) {
	unlink('firsttime.txt');
...
Hello world this is:
<div align="center"><img src="images/ezradius2.png" width="550" height="177"></div>
<!-- InstanceEndEditable -->
    <!-- end #mainContent -->
  </div>
  <div id="footer">
