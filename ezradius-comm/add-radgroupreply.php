...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$query_rsRadGroupReply= sprintf("SELECT * FROM radgroupreply WHERE GroupName = %s AND Attribute=%s", GetSQLValueString($_POST['GroupName'], "text"), GetSQLValueString($_POST['Attribute'], "text"));
	...
	if ($totalRows_rsRadGroupReply<=0) { 
...
<fieldset>
<legend>Add new groupreply attribute</legend>
<?php
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">GroupName:</td>
