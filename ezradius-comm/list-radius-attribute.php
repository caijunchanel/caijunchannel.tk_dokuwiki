...
$replydb = new FFDB();
$replydb->open('attribute');
$replyrec = $replydb->getbyfield("table","/reply/i");

$checkdb = new FFDB();
$checkdb->open('attribute');
$checkrec = $checkdb->getbyfield("table","/check/i");
?>
...
<title>List all freeRADIUS attributes</title>
<!-- InstanceEndEditable -->
...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <p><a href="init-attribute-table.php">Create/reset initial attribute table</a></p>
    <p><a href="add-radius-attribute.php">Add new freeRADIUS attribute</a></p>
    <p><strong>Rad(Group)Check attributes</strong></p>
	...
	<thead class="mythead">
	  ...
	  <tbody class="mytbody">
	  <?php
	  foreach ($checkrec as $rowset) {
	  	echo "<tr>\n";
		echo "<td>".$rowset['id']."</td>\n";
		echo "<td>".$rowset['display']."</td>\n";
		echo "<td>".$rowset['value']."</td>\n";
		echo "<td>".$rowset['version']."</td>\n";
		echo "<td><a href='edit-radius-attribute.php?id=".$rowset['id']."'>Edit</a> <a href='del-radius-attribute.php?id=".$rowset['id']."'>Delete</a> </td>";
		echo "</tr>";
	  }
	  ?>
	  </tbody>
    ...
    <p>&nbsp;</p>
    <p><strong>Rad(Group)Reply attributes  </strong></p>
    <table width="100%" border="1" class="mytable">
	<thead class="mythead">
      <tr>
        <td>ID</td>
