...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <?php if (($totalRows_rsGroupCheck >0) || ($totalRows_rsGroupReply>0)) { // Show if recordset not empty ?>
      <p><strong>Package name : <?php echo $_GET['groupname']; ?></strong> | <a href="list-user-to-group.php?groupname=<?php echo $_GET['groupname']; ?>">Show users</a>| <a href="edit-groupname.php?groupname=<?php echo $_GET['groupname']; ?>">Edit name</a> | <a href="del-group.php?groupname=<?php echo $row_rsGroupReply['GroupName']; ?>">Delete this package</a> | <a href="group-detail-print.php?groupname=<?php echo $_GET['groupname']; ?>">Print this page </a></p>
	  <?php
	  //echo "currShow=".$currShow;
	  if ($currShow==1) {
	  ?>
      	<p><strong>Price : 
		<?php
		...
		$db->close;
		?>
		</strong> | <a href="edit-package-price.php?groupname=<?php echo $_GET['groupname']; ?>">Add/Edit Price</a>		</p>
	  <?php
	  }
	  ?>
      <p><strong>RadGroupCheck</strong> | <a href="add-radgroupcheck.php?groupname=<?php echo $_GET['groupname']; ?>">add new attribute</a></p>
		...
		<thead class="mythead">
          ...
          <?php do { ?>
            <tr>
              ...
              <td><a href="edit-radgroupcheck.php?attrID=<?php echo $row_rsGroupCheck['id']; ?>&amp;groupname=<?php echo $row_rsGroupCheck['GroupName']; ?>">Edit</a> | <a href="del-radgroupcheck.php?id=<?php echo $row_rsGroupCheck['id']; ?>&amp;groupname=<?php echo $row_rsGroupCheck['GroupName']; ?>">Delete</a></td>
            </tr>
            <?php } while ($row_rsGroupCheck = mysql_fetch_assoc($rsGroupCheck)); ?>
		  </tbody>
        </table>
        <?php } // Show if recordset not empty ?>
      <p><strong>RadGroupReply</strong> | <a href="add-radgroupreply.php?groupname=<?php echo $_GET['groupname']; ?>">add new attribute</a></p>
		...
		<thead class="mythead">
          ...
          <?php do { ?>
            <tr>
              ...
              <td><a href="edit-radgroupreply.php?id=<?php echo $row_rsGroupReply['id']; ?>&amp;groupname=<?php echo $row_rsGroupReply['GroupName']; ?>">Edit</a> | <a href="del-radgroupreply.php?id=<?php echo $row_rsGroupReply['id']; ?>&amp;groupname=<?php echo $row_rsGroupReply['GroupName']; ?>">Delete</a></td>
            </tr>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsGroupCheck);

mysql_free_result($rsGroupReply);
?>
